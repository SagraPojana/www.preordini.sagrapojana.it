...
function RequestAndUpdate(){
    ...
    jQuery('.hiddenBlock').removeClass('toogled');
		$('#tabledata_1').html(''); //clean table data
		$('#tabledata_2').html(''); //clean table data
		$('#tabledata_3').html(''); //clean table data
		$('#tabledata_4').html(''); //clean table data
		$('#tabledata_5').html(''); //clean table data
			data = response;
			for( i in data){
				...
				for( k in reparto_data){
					...
					if (desc_tipologia == 'Primi')
					    $('#tabledata_1').append(html);
					if (desc_tipologia == 'Secondi')
					   $('#tabledata_2').append(html);
					if (desc_tipologia == 'Panini')
					   $('#tabledata_3').append(html);
				   	if (desc_tipologia == 'Speciali')
					   $('#tabledata_4').append(html);
				   				}
				}
