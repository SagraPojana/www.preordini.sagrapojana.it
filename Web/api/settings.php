...
if ($method === 'GET') {
  ...
  if (!file_exists($file)) {
    json_out(['error' => 'Impostazioni non configurate.'], 404);
  }
  // NB: non forziamo 'coperto' se manca nel file (impostazioni salvate prima di
  // questa funzione): così non sovrascrive con 0 il valore di config.json.
  json_out(read_json($file, ['title' => 'SAGRA', 'subtitle' => '', 'coperto' => 0]));
}
